...
public class SSLCommerzeService
    {
        ...
        public SSLCommerzeService(string Store_ID, string Store_Pass, bool Store_Test_Mode = false)
        {
        ...
        protected string SendPost(NameValueCollection PostData)
        {
            ...
            string response = SSLCommerzeService.Post(this.SSLCz_URL + this.Submit_URL, PostData);
            return response;
        }
